...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.activities.update", [$activity->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="images">{{ trans('cruds.activity.fields.images') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.activity.fields.images_helper') }}</span>
            </div>
            <div class="form-group">
...
Dropzone.options.imagesDropzone = {
    ...
    init: function () {
@if(isset($activity) && $activity->images)
      var files = {!! json_encode($activity->images) !!}
          for (var i in files) {
          var file = files[i]
          this.options.addedfile.call(this, file)
          this.options.thumbnail.call(this, file, file.preview)
