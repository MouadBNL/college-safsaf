            ...
            <article class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="flex items-center">
                    <div class="w-full relative ratio-720 bg-gray-400 rounded-md">
                        <img src="{{ $latest->image ? $latest->image->url : '#' }}" alt="Image" class="object-cover absolute-full rounded shadow-md">
                    </div>
                </div>
                    <div class="flex items-center">
    ...
    <section class="py-16">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 xl:gap-6 mb-8">
                ...
                @forelse ($posts as $post)
                    <article>
                        ...
                        <div class="w-full relative ratio-720 bg-gray-400 rounded-md mb-3">
                            <img src="{{ $post->image ? $post->image->url : '#' }}" alt="Image" class="object-cover absolute-full rounded shadow-md">
                        </div>
                ...
                @empty
                    <p class="text-center">Il n'y a pas d'articles pour le moment, merci de revenir plus tard</p>
                @endforelse
