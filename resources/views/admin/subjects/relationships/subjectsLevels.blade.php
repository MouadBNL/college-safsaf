...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-subjectsLevels">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($levels as $key => $level)
                        <tr data-entry-id="{{ $level->id }}">
                            ...
                            <td>
                                @foreach($level->subjects as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-subjectsLevels:not(.ajaxTable)').DataTable({ buttons: dtButtons })
