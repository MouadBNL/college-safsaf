...
class LessonController extends Controller
{
    public function index()
    {
        ...
        $lessons = Lesson::with(['level', 'subject'])->get();

        $levels = Level::get();

        $subjects = Subject::get();

        return view('admin.lessons.index', compact('lessons', 'levels', 'subjects'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.lessons.create', compact('levels', 'subjects'));
    }
    ...
    public function edit(Lesson $lesson)
    {
        ...
        return view('admin.lessons.edit', compact('levels', 'subjects', 'lesson'));
    }
